        ...
        <form method="POST" action="{{ route('dashboard.products.store') }}" enctype="multipart/form-data"
            ...
            <div>
                <label class="block text-sm font-medium text-slate-700 mb-2">
                    Precios <span class="text-red-500">*</span>
                </label>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.01" min="0"
                                       ...
                                       value="{{ old("prices.{$list->id}.price_ars") }}"
                                       placeholder="—"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.01" min="0"
                                       ...
                                       value="{{ old("prices.{$list->id}.price_usd") }}"
                                       placeholder="—"
                        ...
                        <div>
                            ...
                            <select name="prices[{{ $list->id }}][currency_default]"
                                    class="w-full border border-slate-300 rounded-lg px-2 py-2 text-sm
                                           focus:outline-none focus:ring-2 focus:ring-blue-400">
                                <option value="ARS" {{ old("prices.{$list->id}.currency_default", 'ARS') === 'ARS' ? 'selected' : '' }}>ARS</option>
                                <option value="USD" {{ old("prices.{$list->id}.currency_default") === 'USD' ? 'selected' : '' }}>USD</option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            {{-- Campos legacy ocultos para compatibilidad (se llenan desde JS con el precio de la lista principal) --}}
