        ...
        <form method="POST" action="{{ route('dashboard.products.store') }}" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="price_ars" value="{{ old('price_ars') }}"
                               step="0.01" min="0"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="price_usd" value="{{ old('price_usd') }}"
                               step="0.01" min="0"
            ...
            <div>
                ...
                <select name="currency_default"
                        class="w-full border border-slate-300 rounded-lg px-3 py-2.5 text-sm
                               focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <option value="ARS" @selected(old('currency_default', 'ARS') === 'ARS')>Pesos (ARS)</option>
                    <option value="USD" @selected(old('currency_default') === 'USD')>Dólares (USD)</option>
                </select>
            </div>
